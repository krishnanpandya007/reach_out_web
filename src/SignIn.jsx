...
function MockRazorPayUI({ logincb }) {
  ...
  <InputGroup size='sm'>
    ...
    <Input onChange={(e) => {setFormData({...formData, name: e.target.value})}} placeholder='Username' />
    <InputRightAddon>
    ...
    <Input onChange={(e) => {setFormData({...formData, password: e.target.value})}} placeholder='Password' />
  </InputGroup>
