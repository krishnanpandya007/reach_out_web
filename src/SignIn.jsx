...
import {Accordion, AccordionButton, AccordionIcon, Link, AccordionItem, AccordionPanel, Box, Button, Center, HStack, PinInput, PinInputField, Spinner, useColorMode, useColorModeValue, useToast} from '@chakra-ui/react'
            ...
            <Center h="calc(100vh - 10vh)" alignItems={'flex-start'} marginTop={'10vh'}>
                ...
                <motion.div className='modal_container' style={{height: 'max-content'}}>
                    ...
                    <div style={{display: 'flex', marginTop: '1rem', gap: '2rem', alignItems: 'center', justifyContent: 'center'}}>
                        <button onClick={() => {setMode('google')}} style={{color: mode === 'google' ? '#59CE8F': colorMode === 'dark' ? '#ffffff80' : '#49494980', fontSize: '0.9rem', fontWeight: mode === 'google' ? '600': '500', boxShadow: mode === 'google' ? '0 0 5px 2px #59CE8F50': colorMode === 'dark' ? '0 0 5px 2px #ffffff30' : '0 0 5px 2px #49494930', padding: '0.4rem 0.8rem', borderRadius: '9px'}}>Google</button>
                        <button onClick={() => {setMode('OTP')}} style={{color: (mode === 'OTP' ? '#59CE8F': colorMode === 'dark' ? '#ffffff80' : '#49494980'), fontSize: '0.9rem', fontWeight: mode === 'OTP' ? '600': '500', boxShadow: mode === 'OTP' ? '0 0 5px 2px #59CE8F50': colorMode === 'dark' ? '0 0 5px 2px #ffffff30' : '0 0 5px 2px #49494930', padding: '0.4rem 0.8rem', borderRadius: '9px'}}>App Code</button>
                    </div>
