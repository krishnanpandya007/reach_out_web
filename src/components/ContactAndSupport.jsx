...
import { Badge, Center, Flex, IconButton, Link, Popover, useToast, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverHeader, PopoverTrigger, Stack, Divider } from '@chakra-ui/react'
          ...
          <Stack direction={'row'}>
            ...
            <Popover>
              ...
              <PopoverContent>
                <PopoverArrow />
                <PopoverCloseButton />
                <PopoverHeader>Links</PopoverHeader>
                <PopoverBody>
                  <a href='mailto:server.reachout@gmail.com'>
                    <Badge textTransform={'initial'} size={'lg'} colorScheme='facebook'>server.reachout@gmail.com</Badge>
                  </a>
                  <br /> 
                  <small><b>Suggestion: </b> prefix your email title with "urgent:" for quick support.</small>
                  <Divider />
                  <Badge textTransform={'initial'} size={'lg'} colorScheme='facebook'>+91 95105-39042</Badge> <br /> <small><b>Note:</b> Call support only available from 9:00 to 20:00 IST.</small>
                  <Divider />
                  <small><b>Address: </b>Aditya courtyard, VV Nagar, Anand, Gujarat, India</small>
                </PopoverBody>
              </PopoverContent>
            </Popover>
