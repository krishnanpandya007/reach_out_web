...
import { Box, Button, Center, Container, Divider, Drawer, DrawerBody, DrawerContent, DrawerHeader, DrawerOverlay, Flex, Menu, MenuButton, MenuItem, MenuList, Modal, ModalBody, ModalCloseButton, ModalContent, ModalHeader, ModalOverlay, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverHeader, PopoverTrigger, Skeleton, useColorMode, useDisclosure } from '@chakra-ui/react'
...
function Header({displayTouchUps}) {
  ...
  return (
    <div className={`header-dynamic ${ scrollDirection === "down" ? "down-header" : "show"}`}>
